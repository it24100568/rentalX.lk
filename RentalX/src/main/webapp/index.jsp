...
<head>
    ...
    <title>RentalX | Vehicle Rental Service</title>
    <style>
        body {
...
<div id="mainPage">
    <header>
        ...
        <div class="section__container header__container" id="home">
            ...
            <div class="header__content">
                ...
                <p>
                    Discover RentalX car rental options in Sri Lanka with Rent a Car Select
        ...
        <div class="registration-form">
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600">Already have an account?
                    <a href="#" class="text-blue-600 hover:underline" onclick="switchToLogin()">Sign in</a>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="registration-form">
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600">Don't have an account?
                    <a href="#" class="text-blue-600 hover:underline" onclick="switchToRegistration()">Sign up</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <footer>
        ...
        <div class="section__container footer__bar">
            <h4>RentalX</h4>
            <p>Copyright © 2024 PG 182 . All rights reserved.</p>
...
<script>
    ...
    function checkLogin() {
        ...
        if (isLoggedIn === 'true') {
            // Redirect to dashboard or profile page instead of showing management
