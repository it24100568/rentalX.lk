...
<html>
<head>
  <title>Admin Registration - Vehicle Rental</title>
...
<div class="card" style="width: 100%; max-width: 450px;">
  <h4 class="text-center text-success mb-4"><i class="fas fa-user-plus me-2"></i>Admin Registration</h4>
  ...
  <p class="mt-3 text-center text-dark">
    Already registered? <a href="admin_login.jsp">Login here</a>
  </p>
</div>
